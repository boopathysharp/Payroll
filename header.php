<header id="page-topbar">
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="index.php" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="assets/images/sharp-info.webp" alt="" height="24">
                            </span>
                            <span class="logo-lg">
                                <img src="https://sharpinfo.co.in/wp-content/uploads/2021/04/final-sharp-info-logov13-1.png" alt="" height="40"> <span class="logo-txt"></span>
                            </span>
                        </a>
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item
                                bg-light-subtle border-start border-end" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="rounded-circle header-profile-user" src="assets/images/sharp-info.webp" alt="Header Avatar">
